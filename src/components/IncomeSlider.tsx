    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Average of the 12 months before birth, or the last calendar year if self-employed.
        </p>
      </div>

      {/* Income display */}
      <div className="flex items-center justify-center gap-1 text-3xl font-bold text-foreground py-2">
      ...
      <div className="flex flex-wrap gap-3 pt-2">
        ...
        <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-secondary/50 border border-border">
          ...
          >
            <SelectTrigger className="h-8 bg-card border-0 shadow-none text-sm min-w-[140px]">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="0">Multiple Birth Bonus</SelectItem>
