...
export function Navbar() {
  return <nav className="h-16 flex items-center justify-between px-6 bg-white">
      ...
      <div className="hidden md:flex items-center gap-8">
        <a href="https://grey-directions-040861.framer.app/#service" className="text-muted-foreground hover:text-foreground transition-colors text-sm">
          Service
        </a>
        <a href="#" className="text-foreground font-medium text-sm">
          Tool
        </a>
        <a href="https://grey-directions-040861.framer.app/#blog" className="text-muted-foreground hover:text-foreground transition-colors text-sm">
          Blog
        </a>
      </div>
